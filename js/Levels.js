    ...
    data: [{
           // 1st level
            ...
            entities: [
                ...
                { type: "block", name: "table1", x: 750, y: 377, angle: 0, width: 214, height: 106, contactSound: 'bounce', },
                { type: "villain", name: "water2", x: 714, y: 280, calories: 200, contactSound: 'wood'},
           ...
           // 2nd level
            ...
            entities: [
				...
				{ type: "block", name: "wood", x: 583, y: 297, angle: 0, width: 172, height: 26, contactSound: 'bounce',},
                { type: "villain", name: "bottle2", x: 583, y: 384, calories: 300, contactSound: 'glass',},
                { type: "villain", name: "glass1", x: 583, y: 257, calories: 270, contactSound: 'glass',},

				// Block 2
                { type: "block", name: "table2", x: 850, y: 362, angle: 0, width: 168, height: 136, contactSound: 'bounce',},
                { type: "villain", name: "flower1", x: 850, y: 233, calories: 300, contactSound: 'wood',},
           ...
           // 3rd level
            ...
            entities: [
				...
				{ type: "block", name: "wood", x: 481, y: 370, angle: 90, width: 120, height: 26, contactSound: 'glass', isStatic: false},
				{ type: "villain", name: "glass2", x: 468, y: 279, calories: 330, contactSound: 'wood', isStatic: false},
				...
				{ type: "block", name: "wood", x: 640, y: 224, angle: 90, width: 120, height: 26, contactSound: 'bounce', isStatic: false},
                { type: "villain", name: "pot3", x: 640, y: 131, calories: 150, contactSound: 'wood', isStatic: false},

				// Block 3				
				{ type: "block", name: "table1", x: 857, y: 377, angle: 0, width: 214, height: 106, contactSound: 'bounce', isStatic: false },
           ...
           // 4th level
            ...
            entities: [
				...
				{ type: "villain", name: "pot2", x: 570, y: 154, calories: 120, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "bottle3", x: 817, y: 387, calories: 840, contactSound: 'wood', isStatic: false},
                ...
                { type: "villain", name: "pot1", x: 817, y: 110, calories: 395, contactSound: 'wood', isStatic: false},
           ...
           // 5th level
            ...
            entities: [
				...
				contactSound: 'wood', isStatic: false},
				{ type: "villain", name: "tv1", x: 540, y: 151, calories: 1000, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "potion1", x: 748, y: 255, calories: 320, contactSound: 'wood', isStatic: false},

				// Block 3
                { type: "villain", name: "pot3", x: 878, y: 397, calories: 300, contactSound: 'wood', isStatic: false},
				{ type: "villain", name: "water1", x: 878, y: 312, calories: 180, contactSound: 'wood', isStatic: false},
           ...
           // 6th level
            ...
            entities: [
				...
				height: 136, // 113 * 1.2
				contactSound: 'wood', isStatic: false},
				{ type: "villain", name: "phone1", x: 640, y: 255, calories: 500, contactSound: 'wood', isStatic: false},
				...
				contactSound: 'wood', isStatic: false},
                { type: "villain", name: "coca_cola", x: 784, y: 299, calories: 733, contactSound: 'wood', isStatic: false},
				...
				height: 248, // 291 * 85 / 100
				contactSound: 'wood', isStatic: false},
                { type: "villain", name: "cover2", x: 908, y: 144, calories: 680, contactSound: 'wood', isStatic: false},
           ...
           // 7th level
            ...
            entities: [
				...
				{ type: "villain", name: "flower1", x: 405, y: 249, calories: 240, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "pot1", x: 810, y: 256, calories: 923, contactSound: 'wood', isStatic: false},
           ...
           // 8th level
            ...
            entities: [
				...
				{ type: "villain", name: "potion2", x: 420, y: 164, calories: 375, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "pot2", x: 525, y: 248, calories: 635, contactSound: 'glass', isStatic: false},
				...
				height: 260, // 291 * 90 / 100
				contactSound: 'wood', isStatic: false},
				{ type: "villain", name: "tv2", x: 710, y: 133, calories: 1000, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "coca_cola", x: 870, y: 251, calories: 775, contactSound: 'glass', isStatic: false},
           ...
           // 9th level
            ...
            entities: [
				...
				// Block 1
				{ type: "block", name: "brown_wood", x: 400, y: 370, angle: 90, width: 120, height: 26, contactSound: 'wood', isStatic: false},
				{ type: "villain", name: "water2", x: 460, y: 386, calories: 490, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "cover2", x: 460, y: 246, calories: 685, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "glass1", x: 460, y: 111, calories: 107, contactSound: 'wood', isStatic: false},				
				...
				height: 136, // 113 * 1.2
				contactSound: 'wood', isStatic: false},
				{ type: "villain", name: "phone1", x: 741, y: 255, calories: 1100, contactSound: 'glass', isStatic: false},
				...
				{ type: "villain", name: "potion1", x: 960, y: 41, calories: 1066, contactSound: 'wood', isStatic: false},
           ...
           // 10th level
            ...
            entities: [
				...
				height: 248, // 291 * 85 / 100
				contactSound: 'wood', isStatic: false},
				{ type: "villain", name: "tv1", x: 640, y: 151, calories: 668, contactSound: 'wood', isStatic: false},				
				...
				height: 248, // 291 * 85 / 100
				contactSound: 'wood', isStatic: false},
                { type: "villain", name: "tv2", x: 790, y: 145, calories: 870, contactSound: 'wood', isStatic: false},
				...
				{ type: "villain", name: "bottle3", x: 932, y: 387, calories: 1234, contactSound: 'glass', isStatic: false},
